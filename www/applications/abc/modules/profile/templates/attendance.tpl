		...
		{if $user->role=='student'}
			...
			{if !$attendance_data.$user_id.attendance}
				...
				<div class="attendance for_user">
					<div class="chart_container">					
						<table class="chart for-student">
							...
							{foreach from=$attendance_data.$user_id.attendance key=time item=att}
				...
				{if $chart|is_array}
					{foreach from=$chart item=gchart key=gid}
						{if $gchart.data}
							...
							{$gchart.schedule}
							<div class="attendance" id="att_{$gid}">
