<?php
/**
 * I gave Recur its very own unittestcase class because its so much more complex than other value types
 * The test files are a mess anyway. This is something we'll fix in future releases
 */
class UnitTestCase_Value_Recur extends UnitTestCase {
     ...
     * be specified once.
     */
    public function testPropertyPermitsMultipleRecurValues() {
     ...
     */
    public function testIntervalSetsHowOftenRecurrenceRepeats() {



    }
    public function testIntervalDefaultsToOne() {
     ...
     */
    public function testUntilEndsRecurrence() {



    }
    // if the UNTIL date falls on an occurance date of the recurrence rule, then that
    // date should be included in the recurrence rule
    public function testIfUntilValueLandsOnAnOccurenceDate() {



    }
    // make sure end date is specified as UTC
    public function testIfUntilIsDateTimeMustBeUtc() {



    }
    // if UNTIL is not present, then there is no COUNT, it should repeat forever
    public function testUntilNotPresent() {
     ...
     */
    public function testCountDefinesAmountOfOccurrences() {



    }
    // if there is a dtstart, it should count as the first occurance
    public function testDtstartCountsAsFirstIfPresent() {
     ...
     * are 0 to 23.
     */
    public function testByIntervalDefinedAsCommaDelimitedList() {

        // test that only these values can be specified for ByInterval parts
     ...
     */
    public function testByDaySpecifiesDays() {
     ...
     */
    public function testByDayAllowPosNegModifiers() {
     ...
     * the month.
     */
    public function testByMonthDaySpecifiesListOfDaysOfMonth() {



    }
    // test that positive and negative modifiers may be used
    public function testByMonthDayPosNegModifiers() {
     ...
     * year (March 1st).
     */
    public function testByYearDaySpecifiesListOfDaysOfYear() {



    }
    // test that positive and negative modifiers may be used
    public function testByYearDayPosNegModifiers() {
     ...
     *     January 1.
     */
    public function testByWeekNoSpecifiesListOfWeeksOfYear() {



    }
    // test that positive and negative modifiers may be used
    public function testByWeekNoPosNegModifiers() {



    }
    // test that this part is only valid for yearly rules
    public function testByWeekNoOnlyValidForYearlyRules() {



    }
    // test that week 53 can only occure when thurs is january 1 or if it is a leap year and wednesday is jan 1
    public function testByWeekNoEdgeCases() {
     ...
     */
    public function testByMonthSpecifiesListOfMonthsOfYear() {
     ...
     */
    public function testWkstSpecifiesWhenWorkWeekStarts() {



    }
    // WKST defaults to monday
    public function testWkstDefaultsToMo() {



    }
    // There are some cases in the docblock directly above, test them
    public function testWkstEdgeCases() {
     ...
     */
    public function testBySetPosSpecifiesListOfNthOccurrence() {



    }
    public function testBySetPosMustOnlyBeUsedInConjunctionWithAnotherByXXXRule() {
     ...
     */
    public function testBySetPosAllowsPosNegModifiers() {



    }
    public function testBySetPosIgnoresInvalidValues() {
     ...
     */
    public function testDtstartDerivedFromDtstartProperty() {
     ...
     */
    public function testByXXXModifiers() {
     ...
     *   BYMINUTE=30
     */
    public function testMultipleByXXXRuleParts() {
     ...
     */
    public function testAllTheCrapAbove() {
