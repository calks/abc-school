<?
    ...
    function createWatermark( $imgObj )
    {
        ...
        $classWatermark = Application :: getClassName( APP_COMPONENT_TYPE_OBJECT, 'watermark' );
        ...
        {
        	$w = Application :: getObjectInstance( 'watermark' );
        ...
        if ($format == 'image') {
            ...
            if (is_uploaded_file(@$resource['tmp_name']) || file_exists(@$resource['tmp_name'])) {
                ...
                if ($acs) {
					...
					$objectClassName = Application :: getClassName( APP_COMPONENT_TYPE_OBJECT, $objectname );
